        ...
        if not isDoingAction then
            ...
            Citizen.CreateThread(function ()
                while isDoingAction do
                    Wait(0)
                    if IsControlJustPressed(0, 178) or IsControlJustPressed(0, 177) or IsControlJustPressed(0, 120) or IsControlJustPressed(0, 114) and mythic_action.canCancel then
